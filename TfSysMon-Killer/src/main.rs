...
struct BYOVD_TEMPLATEIoctlStruct {
    padding: [u8; 4],  // 4 bytes of padding at the start
    pid: DWORD,        // PID starts at offset 4
    extra_padding: [u8; 16], // Additional padding to make the structure 24 bytes long
}
...
impl Driver for BYOVD_TEMPLATE {
    ...
    fn device_name() -> &'static str {
        "\\\\.\\TfSysMon"  // As per your C++ code
    }

    fn ioctl_code() -> DWORD {
        0xB4A00404  // As per your C++ code
    }
