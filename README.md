...
> **Note**: Sophos researchers discovered that **RansomHub ransomware** attackers used a tool named **EDRKillShifter**, which exploited the vulnerable **Sysmon driver** I discovered. This was part of a **BYOVD** attack to disable endpoint protection. Read more: ["Ransomware attackers introduce new EDR killer"](https://sophos.com/news/2024/08/14/ransomware-attackers-introduce-new-edr-killer).
